...
export default class API {
	 ...
	 */
	start (options: StartOptions, errback: ErrProcCallback): void
	/**
	 * Starts a script that will be managed by pm2.
	 ...
	 * The proc parameter will be a pm2 process object.
	 */
	start (jsonConfigFile: string, errback: ErrProcCallback): void
	/**
	 * Starts a script that will be managed by pm2.
	 ...
	 * The proc parameter will be a pm2 process object.
	 */
	start (script: string, errback: ErrProcCallback): void
	/**
	 * Starts a script that will be managed by pm2.
	 * @param script - The path of the script to run.
	 * @param options - Options
	 ...
	 * The proc parameter will be a pm2 process object.
	 */
	start (script: string, options: StartOptions, errback: ErrProcCallback): void
	/**
	 * Starts a script that will be managed by pm2.
	 * @param script - The path of the script to run.
	 * @param jsonConfigFile - The path to a JSON file that can contain the same options as the options parameter.
	 ...
	 * The proc parameter will be a pm2 process object.
	 */
	start (script: string, jsonConfigFile: string, errback: ErrProcCallback): void
